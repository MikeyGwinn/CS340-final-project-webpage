...
-- NOTE: Fixed to use proper foreign key relationships
--
...
--
ALTER TABLE `Internships`
  ADD CONSTRAINT `company_id_constraint` FOREIGN KEY (`company_id`) REFERENCES `Companies` (`company_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `Applications` 
-- FIXED: Now properly references Internships and Students tables
--
ALTER TABLE `Applications`
  ADD CONSTRAINT `internship_id_constraints` FOREIGN KEY (`internship_id`) REFERENCES `Internships` (`internship_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `student_id_constraints` FOREIGN KEY (`student_id`) REFERENCES `Students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `Has_Skill`
--
ALTER TABLE `Has_Skill`
  ADD CONSTRAINT `skill_constraint` FOREIGN KEY (`skill_id`) REFERENCES `Skills` (`skill_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `student_id_constraint` FOREIGN KEY (`student_id`) REFERENCES `Students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
